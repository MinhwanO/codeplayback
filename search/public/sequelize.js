...
async function getTime(timename) {
  try {
    ...
    times.map(function (times) {
      ...
      row.appendChild(td);
      td = document.createElement('td');
      td.textContent = times.big;
      row.appendChild(td);
      td = document.createElement('td');
      td.textContent = times.gyogua;
      row.appendChild(td);
      td = document.createElement('td');
      td.textContent = times.cstime;
      row.appendChild(td);
      td = document.createElement('td');
      td.textContent = times.place;
      row.appendChild(td);
      td = document.createElement('td');
      td.textContent = times.daehak;
      row.appendChild(td);
      td = document.createElement('td');
      td.textContent = times.gaeseol;
      row.appendChild(td);
      td = document.createElement('td');
      td.textContent = times.gshak;
      row.appendChild(td);
      td = document.createElement('td');
      td.textContent = times.pfname;
      row.appendChild(td);
      td = document.createElement('td');
